...
public final class FragmentOrdersBinding implements ViewBinding {
  ...
  private FragmentOrdersBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout emptyState,
      @NonNull ImageView ivEmptyIcon, @NonNull RecyclerView rvList,
  ...
  public static FragmentOrdersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentOrdersBinding((LinearLayout) rootView, emptyState, ivEmptyIcon, rvList,
          swipeRefresh, tabLayout, tvEmptyMessage, tvScreenTitle);
    }
