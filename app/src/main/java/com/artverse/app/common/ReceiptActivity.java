...
public class ReceiptActivity extends AppCompatActivity {
    ...
    private void bind() {
        ...
        tvFooterNote.setText(rejected
                ? "This order was declined by the artist. No payment was collected and "
                        + "the reserved artwork was released back to the gallery."
                : "Payment settled with the artist. Thank you for supporting "
